...
from data.inventory_to_constructs import inventory_to_dimensions, inventory_to_facets
...
def main():
    ...
    inventories_map = inventory_to_facets if args.facets else inventory_to_dimensions
